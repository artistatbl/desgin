...
export function Main({
  ...
  return (
    <main className="h-full min-w-0 overflow-y-auto overflow-x-hidden py-6">
      <div className="mx-auto flex min-h-full w-full max-w-[780px] flex-col px-4 pb-10 lg:px-8 xl:px-10">
